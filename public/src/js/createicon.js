...
export function createIcon(vehiclestatus, licensePlate, timestamp, id) {
  ...
  return L.divIcon({
    ...
    <div class="license-plate-icon">
      <i class="${iconClass}"></i>
      <div class="btn-delete-container" style="display: inline-block; background-color: white; color: black; border: 1px solid black; padding: 2px 4px; font-size: 10px; font-weight: bold; border-radius: 3px; white-space: nowrap;">
        ${clock}${licensePlate}
